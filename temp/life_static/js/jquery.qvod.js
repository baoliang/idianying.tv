...
(function($){
	...
	function insert_player(qvod_address)
	{
		...
		var html = '<iframe id="iframe_down" name="iframe_down" scrolling="no" frameborder="0" style="margin: 0; width: 462px; height: 300px; display: none;" src=""></iframe>'+
		'<div id="qvod2011"><div class="playerarea" style="width:500px; heigth:400px; float:left;">'+
